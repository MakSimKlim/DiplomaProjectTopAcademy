...
namespace DiplomaProjectTopAcademy.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ProjectsController(DiplomaProjectTopAcademyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IDProject,Designation,ProjectName,ChangeNumber,issueDate")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDProject,Designation,ProjectName,ChangeNumber,issueDate")] Project project)
        {
